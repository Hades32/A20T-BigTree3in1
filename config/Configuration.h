...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // A20T-BTT3in1 - based on BIQU B1
  #if ENABLED(PID_PARAMS_PER_HOTEND)
    // Specify between 1 and HOTENDS values per array.
    // If fewer than EXTRUDER values are provided, the last element will be repeated.
    #define DEFAULT_Kp_LIST {  23.34 }
    #define DEFAULT_Ki_LIST {   1.85 }
    #define DEFAULT_Kd_LIST {  73.55 }
  #else
    #define DEFAULT_Kp  12.2
    #define DEFAULT_Ki   0.94
    #define DEFAULT_Kd  39.3
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.8, 400, 409 }
...
#define VALIDATE_HOMING_ENDSTOPS // broken on A20T ?
